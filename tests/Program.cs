...
{
    var definition = ClockComponentDefinition.Create("io.github.touristh.example-clock");
    Assert(definition.Id == "io.github.touristh.example-clock/digital-clock", "component ID must be namespaced.");
